...
<body style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8), rgba(23, 23, 24, 0.9)), radial-gradient(circle, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0));">
    <div class="flex justify-center mt-16">
        <div
            class="shadow-2xl rounded-md p-5 mt-10 1xl:w-[40%] xl:w-[45%] lg:w-[45%] xmd:w-[55%] md:w-[65%] sm:w-[75%] xxsm:w-full" style="background: linear-gradient(to bottom, rgba(0, 255, 0, 1), rgba(0, 255, 0, 0));">
            @if ($errors->any())
                @foreach ($errors->all() as $error)
                    <div id="alert-2"
                        ...
                        <div class="ms-3 text-sm font-medium" style="color:#000000;">
                            {{ $error }}
                        </div>
                        <button type="button"
            ...
            <p class="font-poppins font-bold text-3xl leading-9 text-center pt-6" style="color:#000000;">
                    ...
                    <div
                        ...
                        <label for="default-radio-1" class="w-full">
                            <div
                                ...
                                <label for="default-radio-1" style="color:#000000;">{{ __('User') }}</label>
                            </div>
                        </label>
                        <label for="default-radio-2" class="w-full">
                            <div
                                ...
                                <label style="color:#000000;">{{ __('Organizer') }}</label>
                            </div>
                        </label>
                    </div>
                </div>
