...
<body style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8), rgba(23, 23, 24, 0.9)), radial-gradient(circle, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0));">
    ...
    <div class="flex justify-center mt-32">
        <div
            class="bg-white shadow-2xl rounded-md p-5 mt-10 1xl:w-[28%] xl:w-[35%] lg:w-[40%] xmd:w-[50%] md:w-[60%] sm:w-[70%] xxsm:w-full"  style="background: linear-gradient(to bottom, rgba(0, 255, 0, 1), rgba(0, 255, 0, 0));">
                ...
                <div class="pt-12">
                    <div
                        ...
                        <div
                            ...
                            <label for="" style="color:#000000;">{{ __('User') }}</label>
                        </div>
                        <div
                            class="border border-gray-light py-3.5 px-5 rounded-lg text-gray-100  w-full font-normal font-poppins text-base leading-6 flex">
                            ...
                            <label for="" class="" style="color:#000000;">{{ __('Organizer') }}</label>
                        </div>
                    </div>
                </div>
