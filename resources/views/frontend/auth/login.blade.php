...
<body style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8), rgba(23, 23, 24, 0.9)), radial-gradient(circle, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0));">
    ...
    <div
    class="shadow-2xl rounded-md p-5 mt-10 1xl:w-[28%] xl:w-[35%] lg:w-[40%] xmd:w-[50%] md:w-[60%] sm:w-[70%] xxsm:w-full"
    style="background: linear-gradient(to bottom, rgba(0, 255, 0, 1), rgba(0, 255, 0, 0));">
            ...
            <p class="pt-6 text-3xl font-bold leading-9 text-center font-poppins" style="color:black;">
                    ...
                    <div
                        ...
                        <label for="default-radio-1" class="w-full">
                            <div
                                ...
                                <span style="color:black;">{{ __('User') }}</span>
                            </div>
                        </label>
                        <label for="default-radio-2" class="w-full">
                            <div
                                ...
                                <span style="color:black;">{{ __('Organizer') }}</span>
                            </div>
                        </label>
                    </div>
