...
@section('content')
    ...
    <div class="pb-20 bg-scroll min-h-screen" style="background: linear-gradient(to bottom right, rgba(0, 0, 0, 1), rgba(0, 0, 0, 1));">
        ...
        <div
            ...
            <div class="flex justify-start pt-5 z-10">
                <p
                    class="font-poppins font-semibold md:text-5xl xxsm:text-2xl xsm:text-2xl sm:text-2xl leading-10 " style="color:#0f8f1e;">
                    {{ __('Events') }}</p>&nbsp;&nbsp;
                <p
                    class="font-poppins font-medium md:text-2xl xxsm:text-xl xsm:text-xl sm:text-xl leading-10 pt-3" style="color:#0f8f1e;">
                    ( {{ $events->count() }} )</p>
            </div>
            <div class="mb-4 pt-4">
